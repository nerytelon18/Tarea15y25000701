...
<body class="bg-black text-white min-h-screen flex justify-center font-sans">
    ...
    <div class="w-full max-w-md app-bg min-h-screen flex flex-col relative shadow-2xl overflow-hidden border border-white/10">
        ...
        <div id="main-view" class="flex flex-col w-full h-full overflow-y-auto fade-in">
            ...
            <header class="px-6 pt-6 pb-4 flex items-center justify-between sticky top-0 glass-panel z-20 border-b border-white/5">
                ...
                <button onclick="speakButtonName('Configuración'); openUserModal()" class="w-10 h-10 rounded-full bg-panel flex items-center justify-center text-gray-400 hover:text-white transition-colors slide-up delay-100" title="Configurar Usuario">
            ...
            <main class="flex-1 px-6 py-6 grid grid-cols-2 gap-4 auto-rows-[140px] responsive-bento relative z-10 bg-transparent">
                ...
                <button onclick="speakButtonName('Splash de menta y lavanda'); showSubpage()" class="col-span-2 responsive-bento-wide relative overflow-hidden rounded-[2rem] p-5 flex flex-col justify-end transition-all active:scale-95 shadow-lg border border-white/10 slide-up delay-100 min-h-[160px] group text-left hover:border-emerald-500/30 hover:shadow-emerald-500/10">
                ...
                <button onclick="speakButtonName('Redes'); showSocials()" class="col-span-1 bg-gradient-to-br from-pink-950/30 to-rose-950/30 rounded-[2rem] p-5 flex flex-col justify-between items-start transition-all active:scale-95 shadow-lg slide-up delay-200 hover:bg-pink-200 hover:from-pink-200 hover:to-pink-200 hover:text-slate-900 group">
                ...
                <a href="https://robertotelon.wixsite.com/my-site-5" target="_blank" onclick="speakButtonName('Sitio Oficial')" class="col-span-1 bg-panel rounded-[2rem] p-5 flex flex-col justify-between items-start transition-all active:scale-95 shadow-sm slide-up delay-200 hover:bg-sky-200 hover:text-slate-900 group">
                ...
                <a href="https://www.galileo.edu" target="_blank" onclick="speakButtonName('Ir a mi U')" class="col-span-1 bg-panel rounded-[2rem] p-4 flex flex-col justify-between items-start transition-all active:scale-95 shadow-sm slide-up delay-200 hover:bg-purple-200 hover:text-slate-900 group">
                ...
                <a href="https://www.youtube.com/watch?v=a5MttjQpu5g" target="_blank" onclick="speakButtonName('Video Interactivo')" class="col-span-1 bg-panel rounded-[2rem] p-5 flex flex-col justify-between items-start transition-all active:scale-95 shadow-sm slide-up delay-300 hover:bg-red-200 hover:text-slate-900 group">
                ...
                <button onclick="speakButtonName('Consultor Inteligente IA'); showAIChat()" class="col-span-1 bg-gradient-to-br from-purple-950/40 to-emerald-950/40 rounded-[2rem] p-5 flex flex-col justify-between items-start transition-all active:scale-95 shadow-lg slide-up delay-300 hover:from-purple-900/50 hover:to-emerald-900/50 border border-purple-500/20 group">
            ...
            <div class="px-6 py-2 grid grid-cols-3 gap-4 select-none">
                ...
                <!-- BOTÓN: Descargar App -->
                <button onclick="speakButtonName('Descargar Aplicación'); installPWA()" class="col-span-1 bg-gradient-to-br from-emerald-600/30 to-teal-600/30 rounded-[2rem] border border-emerald-500/20 flex flex-col items-center justify-center gap-1.5 hover:bg-emerald-200 hover:text-slate-900 group active:scale-95 transition-all shadow-lg shadow-emerald-500/10">
            ...
            <footer class="px-6 pb-8 pt-4 mt-auto glass-panel border-t border-white/5 z-20">
                <div class="bg-panel rounded-[2rem] p-4 flex items-center justify-between shadow-sm slide-up delay-300">
                    <div onclick="speakButtonName('Configuración de perfil'); openUserModal()" class="flex items-center gap-3 cursor-pointer group">
                        <div class="relative">
                    ...
                    <!-- Botón de Salir -->
                    <button onclick="speakButtonName('Cerrar sesión'); logoutSession()" class="w-10 h-10 rounded-full bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white transition-colors flex items-center justify-center group" title="Cerrar Sesión">
        ...
        <div id="subpage-view" class="hidden absolute inset-0 bg-dark/85 backdrop-blur-lg z-50 flex-col w-full h-full overflow-y-auto">
            <header class="px-6 pt-10 pb-4 flex items-center gap-4 sticky top-0 glass-panel z-20 border-b border-white/5">
                <button onclick="speakButtonName('Regresar'); hideSubpage()" class="w-10 h-10 rounded-full bg-panel flex items-center justify-center text-gray-400 hover:text-white transition-colors active:scale-90">
        ...
        <div id="socials-view" class="hidden absolute inset-0 bg-dark/85 backdrop-blur-lg z-50 flex-col w-full h-full overflow-y-auto">
            <header class="px-6 pt-10 pb-4 flex items-center gap-4 sticky top-0 glass-panel z-20 border-b border-white/5">
                <button onclick="speakButtonName('Regresar'); hideSocials()" class="w-10 h-10 rounded-full bg-panel flex items-center justify-center text-gray-400 hover:text-white transition-colors active:scale-90">
                    <i class="fa-solid fa-arrow-left"></i>
                </button>
        ...
        <div id="catalog-view" class="hidden absolute inset-0 bg-dark/85 backdrop-blur-lg z-50 flex-col w-full h-full overflow-y-auto">
            <header class="px-6 pt-10 pb-4 flex items-center justify-between sticky top-0 glass-panel z-20 border-b border-white/5">
                <div class="flex items-center gap-4">
                    <button onclick="speakButtonName('Regresar'); hideCatalog()" class="w-10 h-10 rounded-full bg-panel flex items-center justify-center text-gray-400 hover:text-white transition-colors active:scale-90">
                        <i class="fa-solid fa-arrow-left"></i>
                    </button>
            ...
            <main class="flex-1 px-6 py-6 flex flex-col gap-6 fade-in">
                ...
                <div class="bg-panel rounded-[2rem] p-5 shadow-xl flex flex-col gap-4 relative overflow-hidden">
                    ...
                    <div class="flex items-center justify-between border-t border-white/5 pt-4 mt-2">
                        <div>
                            <span class="block text-[10px] text-gray-400 font-bold uppercase tracking-widest">Precio estimado</span>
                            <span id="product-price" class="text-2xl font-black text-white">$12.50 <span class="text-xs font-normal text-gray-400">USD</span></span>
                        </div>
                        <button onclick="speakButtonName('Adquirir o Solicitar'); goToFormFromStore()" class="bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white font-bold text-xs py-2.5 px-4 rounded-xl shadow-lg shadow-emerald-600/25 transition-all flex items-center gap-2 border border-emerald-400/30">
        ...
        <div id="form-view" class="hidden absolute inset-0 bg-dark/85 backdrop-blur-lg z-50 flex-col w-full h-full overflow-y-auto">
            <header class="px-6 pt-10 pb-4 flex items-center gap-4 sticky top-0 glass-panel z-20 border-b border-white/5">
                <button onclick="speakButtonName('Regresar'); hideFormView()" class="w-10 h-10 rounded-full bg-panel flex items-center justify-center text-gray-400 hover:text-white transition-colors active:scale-90">
                    <i class="fa-solid fa-arrow-left"></i>
                </button>
                ...
                <div class="bg-panel rounded-[2rem] p-6 shadow-xl flex flex-col gap-4">
                    ...
                    <form id="order-form" onsubmit="handleFormSubmission(event)" class="flex flex-col gap-4 text-left">
                        ...
                        <div class="grid grid-cols-2 gap-3 bg-black/40 p-3 rounded-xl border border-white/5">
                            <div>
                                <span class="block text-[10px] text-gray-400 font-bold uppercase">Variante</span>
                                <span id="form-summary-variant" class="text-xs font-bold text-white">Menta & Lavanda</span>
                            </div>
                            <div>
                                <span class="block text-[10px] text-gray-400 font-bold uppercase">Tamaño / Precio</span>
                                <span id="form-summary-price" class="text-xs font-bold text-indigo-400">120 mL ($12.50)</span>
                            </div>
                        </div>
                        ...
                        <!-- Botón de Envío y Redirección -->
                        <button type="submit" onclick="speakButtonName('Verificar y Abrir Formulario')" class="w-full bg-indigo-600 hover:bg-indigo-500 text-white rounded-[1.5rem] p-4 font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-indigo-600/20 active:scale-95 border border-indigo-400/30 mt-4">
        ...
        <div id="ai-chat-view" class="hidden absolute inset-0 bg-dark/85 backdrop-blur-lg z-50 flex-col w-full h-full overflow-y-auto">
            <header class="px-6 pt-10 pb-4 flex items-center gap-4 sticky top-0 glass-panel z-20 border-b border-purple-500/10">
                <button onclick="speakButtonName('Regresar'); hideAIChat()" class="w-10 h-10 rounded-full bg-panel flex items-center justify-center text-gray-400 hover:text-white transition-colors active:scale-90">
                    <i class="fa-solid fa-arrow-left"></i>
                </button>
                <div class="flex items-center gap-2">
        ...
        <div id="user-modal" class="hidden fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-6">
            <div class="bg-panel w-full max-w-xs rounded-[2.5rem] p-6 shadow-2xl flex flex-col gap-4 text-left">
                ...
                <div class="flex gap-2 mt-2">
                    <button onclick="speakButtonName('Cancelar'); closeUserModal()" class="flex-1 bg-white/10 hover:bg-white/20 text-white rounded-xl py-2 text-xs font-bold transition-all">
                        Cancelar
                    </button>
                    <button onclick="speakButtonName('Guardar cambios'); saveUserModal()" class="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl py-2 text-xs font-bold transition-all">
                        Guardar
                    </button>
                </div>
            </div>
        ...
        <div id="download-modal" class="hidden fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-6">
            <div class="bg-panel w-full max-w-xs rounded-[2.5rem] p-6 shadow-2xl flex flex-col gap-4 text-left border border-white/10">
                ...
                <button onclick="speakButtonName('Entendido'); closeDownloadModal()" class="w-full bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl py-2.5 text-xs font-bold transition-all active:scale-95">
                    Entendido
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        function updateProductPrice() {
            ...
            const price = prices[size] || 12.50;
            
            priceSpan.style.opacity = '0.3';
            setTimeout(() => {
                priceSpan.innerHTML = `$${price.toFixed(2)} <span class="text-xs font-normal text-gray-400">USD</span>`;
        ...
        function updateFormSummary() {
            ...
            document.getElementById('form-summary-variant').innerText = variantText;
            document.getElementById('form-summary-price').innerText = `${size} ($${price.toFixed(2)} USD)`;
        }
        ...
        // --- Función global para locución en botones ---
        function speakButtonName(buttonName) {
            window.speechSynthesis.cancel();
        ...
        // --- Lógica de Redes Sociales con Web Speech API e Interactividad ---
        function handleSocialClick(platformName, redirectUrl) {
            window.speechSynthesis.cancel();

            const utterance = new SpeechSynthesisUtterance("Abriendo " + platformName);
            if (preferredVoice) {
                utterance.voice = preferredVoice;
            } else {
                utterance.lang = 'es-MX';
        ...
        // --- SISTEMA INTEGRADOR DE GEMINI API ---
        async function queryGemini(userQuery) {
            const apiKey = ""; // Llave asignada en runtime por el entorno
            const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-09-2025:generateContent?key=${apiKey}`;
            
            const systemPrompt = "Eres un consultor científico experto en fisicoquímica y formulación cosmética para la aplicación de RAOULT'S MIST de la Universidad Galileo. Tu objetivo es responder preguntas técnicas sobre body splash, solubilidad de aceites esenciales (menta y lavanda), humectantes como glicerina, y explicar de manera clara y didáctica cómo influye la Ley de Raoult en la estabilidad y presión de vapor de estas mezclas. Sé profesional, amigable, claro y responde en español.";
            ...
            if (isAI) {
                ...
                messageDiv.innerHTML = `
                    ...
                    <div class="flex items-center justify-between mt-1">
                        <button onclick="speakButtonName('Escuchar respuesta'); speakText(\`${text.replace(/`/g, '\\`').replace(/"/g, '&quot;')}\`)" class="text-purple-400 hover:text-purple-300 text-[10px] flex items-center gap-1 font-bold">
